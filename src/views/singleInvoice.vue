        ...
        <div v-for="invoice in filterById(id)" :key="invoice.id">
          ...
          <v-card class="my-4 px-5 pb-1 pt-5 secondary rounded-lg">
            ...
            <div class="inner-flex mt-8">
              <div>
                <div>
                  ...
                  <p class="font-weight-bold">{{formatDate(invoice.createdAt)}}</p>
                </div>
                <div>
                  <h3 class="font-weight-light mb-3 mt-8">Payment Due</h3>
                  <p class="font-weight-bold">{{formatDate(invoice.paymentDue)}}</p>
                </div>
              </div>
              <div>
            ...
            <v-card class="my-4 px-5 py-4 primary rounded-lg d-mobile">
              <div v-for="item in invoice.items" :key="item.index" class="mb-2 d-flex justify-space-between align-center">
                <div>
